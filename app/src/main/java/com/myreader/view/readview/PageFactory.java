 ...
 */
package com.myreader.view.readview;
...
public class PageFactory {
    ...
    public PageFactory(Context context, int width, int height, int fontSize, String bookId,
        ...
        mTitlePaint.setColor(ContextCompat.getColor(BaseApplication.getInstance().getApplicationContext(), R.color.chapter_title_day));
