...
import com.myreader.entity.support.BookMark;
import com.myreader.entity.support.DownloadMessage;
import com.myreader.entity.support.DownloadProgress;
import com.myreader.entity.support.DownloadQueue;
import com.myreader.entity.support.ReadTheme;
import com.myreader.manager.CacheManager;
import com.myreader.manager.CollectionsManager;
import com.myreader.manager.EventManager;
import com.myreader.manager.SettingManager;
import com.myreader.manager.ThemeManager;
import com.myreader.service.DownloadBookService;
import com.myreader.ui.adapter.BookMarkAdapter;
import com.myreader.ui.adapter.TocListAdapter;
import com.myreader.ui.contract.BookReadContract;
import com.myreader.ui.easyadapter.ReadThemeAdapter;
import com.myreader.ui.presenter.BookReadPresenter;
import com.myreader.util.Constant;
import com.myreader.util.FileUtils;
import com.myreader.util.FormatUtils;
import com.myreader.util.LogUtils;
import com.myreader.util.ScreenUtils;
import com.myreader.util.SharedPreferencesUtil;
import com.myreader.util.TTSPlayerUtils;
import com.myreader.util.ToastUtils;
import com.myreader.view.readview.BaseReadView;
import com.myreader.view.readview.OnReadStateChangeListener;
import com.myreader.view.readview.OverlappedWidget;
import com.myreader.view.readview.PageWidget;
...
public class ReadActivity extends BaseActivity implements BookReadContract.View {
    ...
    @Bind(R.id.ivBack) ImageView mIvBack;
//    @Bind(R.id.tvBookReadReading) TextView mTvBookReadReading;
    @Bind(R.id.tvBookReadCommunity) TextView mTvBookReadCommunity;
    @Bind(R.id.tvBookReadIntroduce) TextView mTvBookReadChangeSource;
    @Bind(R.id.tvBookReadSource) TextView mTvBookReadSource;

    @Bind(R.id.flReadWidget) FrameLayout flReadWidget;

    @Bind(R.id.llBookReadTop) LinearLayout mLlBookReadTop;
    @Bind(R.id.tvBookReadTocTitle) TextView mTvBookReadTocTitle;
    @Bind(R.id.tvBookReadMode) TextView mTvBookReadMode;
    @Bind(R.id.tvBookReadSettings) TextView mTvBookReadSettings;
    @Bind(R.id.tvBookReadDownload) TextView mTvBookReadDownload;
    @Bind(R.id.tvBookReadToc) TextView mTvBookReadToc;
    @Bind(R.id.llBookReadBottom) LinearLayout mLlBookReadBottom;
    @Bind(R.id.rlBookReadRoot) RelativeLayout mRlBookReadRoot;
    @Bind(R.id.tvDownloadProgress) TextView mTvDownloadProgress;

    @Bind(R.id.rlReadAaSet) LinearLayout rlReadAaSet;
    @Bind(R.id.ivBrightnessMinus) ImageView ivBrightnessMinus;
    @Bind(R.id.seekbarLightness) SeekBar seekbarLightness;
    @Bind(R.id.ivBrightnessPlus) ImageView ivBrightnessPlus;
    @Bind(R.id.tvFontsizeMinus) TextView tvFontsizeMinus;
    @Bind(R.id.seekbarFontSize) SeekBar seekbarFontSize;
    @Bind(R.id.tvFontsizePlus) TextView tvFontsizePlus;

    @Bind(R.id.rlReadMark) LinearLayout rlReadMark;
    @Bind(R.id.tvAddMark) TextView tvAddMark;
    @Bind(R.id.lvMark) ListView lvMark;

    @Bind(R.id.cbVolume) CheckBox cbVolume;
    @Bind(R.id.cbAutoBrightness) CheckBox cbAutoBrightness;
    @Bind(R.id.gvTheme) GridView gvTheme;
