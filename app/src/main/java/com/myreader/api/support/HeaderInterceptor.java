 ...
 */
package com.myreader.api.support;

import com.myreader.BaseApplication;
import com.myreader.util.DeviceUtils;
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        if (url.contains("book/") ||
            ...
            Request request = original.newBuilder()
                    ...
                    .addHeader("X-Device-Id", DeviceUtils.getIMEI(BaseApplication.getInstance().getApplicationContext()))
