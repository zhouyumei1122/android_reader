...
/**
 * Created by dsx on 2017/2/16 0016.
 */
...
public class Constant {
    ...
    public static String PATH_DATA = FileUtils.createRootPath(BaseApplication.getInstance().getApplicationContext()) + "/cache";

    public static String PATH_COLLECT = FileUtils.createRootPath(BaseApplication.getInstance().getApplicationContext()) + "/collect";
    ...
    public static String BASE_PATH = BaseApplication.getInstance().getApplicationContext().getCacheDir().getPath();
