...
public class ScreenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * BaseApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / BaseApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / BaseApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * BaseApplication.getInstance().getApplicationContext().getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    private int getStatusBarHeight() {
        ...
        try {
            ...
            sbar = BaseApplication.getInstance().getApplicationContext().getResources().getDimensionPixelSize(x);
        } catch (Exception e1) {
            e1.printStackTrace();
        }
        return sbar;
