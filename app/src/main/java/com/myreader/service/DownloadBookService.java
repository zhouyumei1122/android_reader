...
import com.myreader.api.support.Logger;
import com.myreader.api.support.LoggingInterceptor;
...
import com.myreader.util.NetworkUtils;
        ...
        AsyncTask<Integer, Integer, Integer> downloadTask = new AsyncTask<Integer, Integer, Integer>() {
            ...
            protected Integer doInBackground(Integer... params) {
                ...
                for (int i = start; i <= end && i <= list.size(); i++) {
                    ...
                    // 网络异常，取消下载
                    if (!NetworkUtils.isAvailable(BaseApplication.getInstance().getApplicationContext())) {
